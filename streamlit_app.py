...
#Dashboard
st.title("Provincial Public Administration Employees per 1000 Residents")
#st.set_page_config(page_title = "Provincial Public Administration Employees per 1000 Residents", 
 #                 page_icon=":bar_chart:",
  #                 layout="wide")

st.sidebar.header("Dashboard Description, Alberta Metrics Only or All Provinces Metrics")
add_sidebar = st.sidebar.selectbox('Please select dimension', ('Dashboard Description', 'Alberta Metrics Only', 'All Provinces Metrics'))

if add_sidebar=="Alberta Metrics Only":
...
if add_sidebar=="All Provinces Metrics":
    st.subheader("Please filter here:")
